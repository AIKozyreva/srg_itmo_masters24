...
КАПЕЦ так оказывается snpEff выдаёт три файла, ё-моё, где ты был всю мою жизнь. Есть, кроме основного 'annotated_comp1_variants.vcf' ещё файлы 'snpeff_genes.txt', 'snpEff_summary.html'. Что-то на полезном.
