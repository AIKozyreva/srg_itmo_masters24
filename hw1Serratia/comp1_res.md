## comparision ref Serratia rubidaea RefSeq GCF_016026735 VS Serratia rubidaea strain 53550_B01 GCF_900638005
...
В итоге поиск значимых хитов я делала с помощью своего скрипта на питоне, в котором могут быть ошибки, но я наждеюсь, что их нет. 
Значимых мутаций 239 штук. Генов, для которых в референсной гфф есть указано название 23 штуки. Я проверила все эти 239 мутаций своим скриптом, они происходят в 23 аннотированных и имеющих общеиспользуемое имя генах, для которых известны продукты. 
Список генов: vapB', 'acpS', 'bamA', 'ccdA', 'ccdB', 'citG', 'citX', 'dsbB',  'exuR', 'fruA', 'ispD', 'ltaE', 'mgrA', 'nudI', 'nudK', 'pyk', 'rfbC', 'rfbD', 'rpsM', 'tolA', 'tonB', 'wecA', 'wzc'
